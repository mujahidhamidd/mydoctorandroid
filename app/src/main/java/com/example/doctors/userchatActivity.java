...
public class userchatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress_dialog = new ProgressDialog(userchatActivity.this);
        ...
        user_id=SharedPrefManager.getInstance(userchatActivity.this).getserid();
    ...
    private void load_all_messages()
    {
        ...
        pd = new ProgressDialog(userchatActivity.this);
        ...
        StringRequest updateReq = new StringRequest(Request.Method.POST, "http://10.0.3.2/doctors_backend/api/allmessages.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        layoutManager = new LinearLayoutManager(userchatActivity.this,LinearLayoutManager.VERTICAL,false);
                        chat_messages_Recyclerview.setLayoutManager(layoutManager);
                        chat__Adapter = new Chat__Adapter(userchatActivity.this, Messages_list);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(res.getString("result").equalsIgnoreCase("success")){
                                ...
                                Intent intent = new Intent(userchatActivity.this, doctorhome.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);

                                load_all_messages();
                                // startActivity(intent);
                                Toast.makeText(userchatActivity.this, ""+   res.getString("message") , Toast.LENGTH_SHORT).show();
                            }
                            else{
